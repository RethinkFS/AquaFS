...
| 基于 Zone 的智能动态分区 RAID | 全盘 RAID 模式、<br />分区 RAID 模式等<br />整体进度约70% | 1️⃣ 全盘 RAID 模式支持 RAID0、RAID1<br/>2️⃣ 分区 RAID 模式在建立文件系统时或空间不足时自动分配新的 Zone 映射和 RAID 逻辑<br />3️⃣ RAID0 对单线程 IO 读写有加速效果<br />4️⃣ RAID1 对读有加速效果，同时发生数据损坏时可以屏蔽坏块并自动恢复数据<br /> |

![image-20230606174006470](README.assets/image-20230606174006470.png)

![image-20230606174018365](README.assets/image-20230606174018365.png)
